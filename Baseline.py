...
# Number of epochs and batch size influencing overfitting
...
# Data Pre-procesesing -----------------------------------------------------------------------------    

# Load data in a list from a file directory
...
def get_test_data(data_dir):
    ...
    img_path_list.sort(key=lambda x:int(x.split('/')[-1].split('.')[0].split('\\')[2]))
